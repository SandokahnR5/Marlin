...
#define HOMING_BACKOFF_POST_MM { 5, 5, 10 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  50, 50 }, { 300,  50 }, { 175, 300 } }
   ...
   * driver order.
   */
  #define Z_STEPPER_ALIGN_STEPPER_XY { { -40, 0 }, { -400, 0 }, { 175, 400 } }
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 320,  30 }, { 320, 320 }, { 30, 320 } }
 ...
 */
#define SAFE_BED_LEVELING_START_X 350
#define SAFE_BED_LEVELING_START_Y 350
#define SAFE_BED_LEVELING_START_Z 10
